...
```
For a combined snapshot, `scripts/check-launch.py` also writes `artifacts/outreach-summary.md`
with an `ethical_growth_score` and concrete `next_growth_actions` to guide your next
outreach batch.
