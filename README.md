...
The public guides follow the current `main` catalog (66 diagnostics). Stable
...
- Amazon Bedrock first-use access and unresolved model-identifier failures,
  with account, Region, model catalog, endpoint, and API checks
