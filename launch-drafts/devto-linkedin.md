...
handful of others. 29 rules at the moment; `sam-doctor rules` lists the current set.
...
GitHub Actions deployment logs locally and matches them against a growing catalog of known
