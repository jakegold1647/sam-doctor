...
to find work that is definitely real. The latest run on 2026-08-10 diagnosed 226 of
250 excerpts (90%). That percentage is a moving sample, not a release guarantee;
