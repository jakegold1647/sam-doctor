...
to find work that is definitely real. The latest run on 2026-08-10 diagnosed 227 of
250 excerpts (91%). That percentage is a moving sample, not a release guarantee;
