...
ERROR_PAGE_MAP: dict[str, str] = {
    ...
    "iam.role.managed-policy-attachment-limit": "iam-role-managed-policy-attachment-limit.html",
    ...
    "cloudformation.template.circular-dependency": "cloudformation-circular-dependency.html",
    ...
    "cdk.asset.bundling-failed": "cdk-asset-bundling-failed.html",
    ...
    "ec2.user-data.size-limit-exceeded": "ec2-user-data-size-limit.html",
    "lambda.layers.size-limit-exceeded": "lambda-layers-size-limit.html",
    ...
    "apigateway.security-policy.endpoint-access-required": "apigateway-security-policy-endpoint-access-required.html",
